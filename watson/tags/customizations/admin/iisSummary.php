...
//	echo '</pre>';
	...
	while ($drow = $dresult->FetchRow())
	{
		...
		<table>
			<thead>
			<tr>
				<th><h3>Participant Code #: <? echo $drow['67237X62X152'] ?></h3></th>
		...
		$impI = ($drow['67237X63X153think'] + $drow['67237X63X153feel'] + $drow['67237X63X153decid']) / 3;		
		
		?>
		<table>
			<caption>
					<b>Importance of Ideal Self</b>
			</caption>
			<tbody>
			<tr class='even'>
				<th>
